...
def tac_lt(ast_lt, tac):
	...
	tac += [TACUnbox(val1, e1)]
	tac += [TACUnbox(val2, e2)]
	tac += [TACLessThan(result, val1, val2, ast_lt.static_type)]
	tac += [TACBox(box, result, box_type)]
	return box
...
def tac_le(ast_le, tac):
	...
	tac += [TACUnbox(val1, e1)]
	tac += [TACUnbox(val2, e2)]
	tac += [TACLessEquals(result, val1, val2, ast_le.static_type)]
	tac += [TACBox(box, result, box_type)]
	return box
...
def tac_eq(ast_eq, tac):
	...
	tac += [TACUnbox(val1, e1)]
	tac += [TACUnbox(val2, e2)]
	tac += [TACEquals(result, val1, val2, ast_eq.static_type)]
	tac += [TACBox(box, result, box_type)]
	return box
