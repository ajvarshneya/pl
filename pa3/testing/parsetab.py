...
_lr_productions = [
  ...
  ('program -> classes','program',1,'p_program','main.py',70),
  ('classes -> class SEMI classes','classes',3,'p_classes','main.py',77),
  ('classes -> class SEMI','classes',2,'p_classes_base','main.py',82),
  ('class -> CLASS TYPE INHERITS TYPE LBRACE features RBRACE','class',7,'p_class_inherits','main.py',87),
  ('class -> CLASS TYPE LBRACE features RBRACE','class',5,'p_class_no_inherits','main.py',92),
  ('features -> feature SEMI features','features',3,'p_features','main.py',97),
  ('features -> <empty>','features',0,'p_features_base','main.py',102),
  ('feature -> IDENTIFIER LPAREN formals RPAREN COLON TYPE LBRACE expr RBRACE','feature',9,'p_feature_method_formals','main.py',112),
  ('feature -> IDENTIFIER LPAREN RPAREN COLON TYPE LBRACE expr RBRACE','feature',8,'p_feature_method','main.py',117),
  ('feature -> IDENTIFIER COLON TYPE LARROW expr','feature',5,'p_feature_init','main.py',122),
  ('feature -> IDENTIFIER COLON TYPE','feature',3,'p_feature','main.py',127),
  ('formals -> formal COMMA formals','formals',3,'p_formals','main.py',132),
  ('formals -> formal','formals',1,'p_formals_base','main.py',137),
  ('formal -> IDENTIFIER COLON TYPE','formal',3,'p_formal','main.py',145),
  ('expr -> IDENTIFIER LARROW expr','expr',3,'p_expr_assign','main.py',152),
  ('expr -> expr DOT IDENTIFIER LPAREN exprs RPAREN','expr',6,'p_expr_dynamic_dispatch_params','main.py',162),
  ('expr -> expr DOT IDENTIFIER LPAREN RPAREN','expr',5,'p_expr_dynamic_dispatch','main.py',168),
  ('expr -> expr AT TYPE DOT IDENTIFIER LPAREN exprs RPAREN','expr',8,'p_expr_static_dispatch_params','main.py',175),
  ('expr -> expr AT TYPE DOT IDENTIFIER LPAREN RPAREN','expr',7,'p_expr_static_dispatch','main.py',181),
  ('expr -> IDENTIFIER LPAREN exprs RPAREN','expr',4,'p_expr_dispatch_params','main.py',188),
  ('expr -> IDENTIFIER LPAREN RPAREN','expr',3,'p_expr_dispatch','main.py',194),
  ('exprs -> expr COMMA exprs','exprs',3,'p_exprs','main.py',200),
  ('exprs -> expr','exprs',1,'p_exprs_base','main.py',205),
  ('expr -> IF expr THEN expr ELSE expr FI','expr',7,'p_expr_if','main.py',213),
  ('expr -> WHILE expr LOOP expr POOL','expr',5,'p_expr_while','main.py',220),
  ('expr -> LBRACE exprsemi RBRACE','expr',3,'p_block','main.py',227),
  ('exprsemi -> expr SEMI exprsemi','exprsemi',3,'p_exprsemi','main.py',233),
  ('exprsemi -> expr SEMI','exprsemi',2,'p_exprsemi_base','main.py',238),
  ('expr -> LET bindings IN expr','expr',4,'p_expr_let','main.py',246),
  ('bindings -> IDENTIFIER COLON TYPE LARROW expr bindings_tail','bindings',6,'p_bindings_init','main.py',253),
  ('bindings -> IDENTIFIER COLON TYPE bindings_tail','bindings',4,'p_bindings_no_init','main.py',258),
  ('bindings_tail -> COMMA IDENTIFIER COLON TYPE LARROW expr bindings_tail','bindings_tail',7,'p_bindings_tail_init','main.py',263),
  ('bindings_tail -> COMMA IDENTIFIER COLON TYPE bindings_tail','bindings_tail',5,'p_bindings_tail_no_init','main.py',268),
  ('bindings_tail -> <empty>','bindings_tail',0,'p_bindings_base','main.py',272),
  ('expr -> CASE expr OF cases ESAC','expr',5,'p_expr_case','main.py',278),
  ('cases -> IDENTIFIER COLON TYPE RARROW expr SEMI cases','cases',7,'p_cases','main.py',285),
  ('cases -> IDENTIFIER COLON TYPE RARROW expr SEMI','cases',6,'p_cases_base','main.py',290),
  ('expr -> NEW TYPE','expr',2,'p_expr_new','main.py',299),
  ('expr -> ISVOID expr','expr',2,'p_expr_isvoid','main.py',306),
  ('expr -> expr PLUS expr','expr',3,'p_expr_plus','main.py',313),
  ('expr -> expr MINUS expr','expr',3,'p_expr_minus','main.py',319),
  ('expr -> expr TIMES expr','expr',3,'p_expr_times','main.py',325),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr_divide','main.py',331),
  ('expr -> expr LT expr','expr',3,'p_expr_lt','main.py',338),
  ('expr -> expr LE expr','expr',3,'p_expr_le','main.py',344),
  ('expr -> expr EQUALS expr','expr',3,'p_expr_equals','main.py',350),
  ('expr -> NOT expr','expr',2,'p_expr_not','main.py',357),
  ('expr -> TILDE expr','expr',2,'p_expr_negate','main.py',364),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_parens','main.py',370),
  ('expr -> IDENTIFIER','expr',1,'p_expr_identifier','main.py',377),
  ('expr -> INTEGER','expr',1,'p_expr_integer','main.py',384),
  ('expr -> STRING','expr',1,'p_expr_string','main.py',390),
  ('expr -> TRUE','expr',1,'p_expr_true','main.py',396),
  ('expr -> FALSE','expr',1,'p_expr_false','main.py',402),
]
