...
_lr_productions = [
  ...
  ('program -> classes','program',1,'p_program','main.py',68),
  ...
  ('feature -> IDENTIFIER LPAREN formals RPAREN COLON TYPE LBRACE expr RBRACE','feature',9,'p_feature_method_formals','main.py',110),
  ('feature -> IDENTIFIER LPAREN RPAREN COLON TYPE LBRACE expr RBRACE','feature',8,'p_feature_method','main.py',115),
  ('feature -> IDENTIFIER COLON TYPE LARROW expr','feature',5,'p_feature_init','main.py',120),
  ('feature -> IDENTIFIER COLON TYPE','feature',3,'p_feature','main.py',125),
  ('formals -> formal COMMA formals','formals',3,'p_formals','main.py',130),
  ('formals -> formal','formals',1,'p_formals_base','main.py',135),
  ('formal -> IDENTIFIER COLON TYPE','formal',3,'p_formal','main.py',143),
  ('expr -> IDENTIFIER LARROW expr','expr',3,'p_expr_assign','main.py',150),
  ('expr -> expr DOT IDENTIFIER LPAREN exprs RPAREN','expr',6,'p_expr_dynamic_dispatch_params','main.py',160),
  ('expr -> expr DOT IDENTIFIER LPAREN RPAREN','expr',5,'p_expr_dynamic_dispatch','main.py',166),
  ('expr -> expr AT TYPE DOT IDENTIFIER LPAREN exprs RPAREN','expr',8,'p_expr_static_dispatch_params','main.py',173),
  ('expr -> expr AT TYPE DOT IDENTIFIER LPAREN RPAREN','expr',7,'p_expr_static_dispatch','main.py',179),
  ('expr -> IDENTIFIER LPAREN exprs RPAREN','expr',4,'p_expr_dispatch_params','main.py',186),
  ('expr -> IDENTIFIER LPAREN RPAREN','expr',3,'p_expr_dispatch','main.py',192),
  ('exprs -> expr COMMA exprs','exprs',3,'p_exprs','main.py',198),
  ('exprs -> expr','exprs',1,'p_exprs_base','main.py',203),
  ('expr -> IF expr THEN expr ELSE expr FI','expr',7,'p_expr_if','main.py',211),
  ('expr -> WHILE expr LOOP expr POOL','expr',5,'p_expr_while','main.py',218),
  ('expr -> LBRACE exprsemi RBRACE','expr',3,'p_block','main.py',225),
  ('exprsemi -> expr SEMI exprsemi','exprsemi',3,'p_exprsemi','main.py',231),
  ('exprsemi -> expr SEMI','exprsemi',2,'p_exprsemi_base','main.py',236),
  ('expr -> LET bindings IN expr','expr',4,'p_expr_let','main.py',244),
  ('bindings -> IDENTIFIER COLON TYPE LARROW expr bindings_tail','bindings',6,'p_bindings_init','main.py',251),
  ('bindings -> IDENTIFIER COLON TYPE bindings_tail','bindings',4,'p_bindings_no_init','main.py',256),
  ('bindings_tail -> COMMA IDENTIFIER COLON TYPE LARROW expr bindings_tail','bindings_tail',7,'p_bindings_tail_init','main.py',261),
  ('bindings_tail -> COMMA IDENTIFIER COLON TYPE bindings_tail','bindings_tail',5,'p_bindings_tail_no_init','main.py',266),
  ('bindings_tail -> <empty>','bindings_tail',0,'p_bindings_base','main.py',270),
  ('expr -> CASE expr OF cases ESAC','expr',5,'p_expr_case','main.py',276),
  ('cases -> IDENTIFIER COLON TYPE RARROW expr SEMI cases','cases',7,'p_cases','main.py',283),
  ('cases -> IDENTIFIER COLON TYPE RARROW expr SEMI','cases',6,'p_cases_base','main.py',288),
  ('expr -> NEW TYPE','expr',2,'p_expr_new','main.py',297),
  ('expr -> ISVOID expr','expr',2,'p_expr_isvoid','main.py',304),
  ('expr -> expr PLUS expr','expr',3,'p_expr_plus','main.py',311),
  ('expr -> expr MINUS expr','expr',3,'p_expr_minus','main.py',317),
  ('expr -> expr TIMES expr','expr',3,'p_expr_times','main.py',323),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr_divide','main.py',329),
  ('expr -> expr LT expr','expr',3,'p_expr_lt','main.py',336),
  ('expr -> expr LE expr','expr',3,'p_expr_le','main.py',342),
  ('expr -> expr EQUALS expr','expr',3,'p_expr_equals','main.py',348),
  ('expr -> NOT expr','expr',2,'p_expr_not','main.py',355),
  ('expr -> TILDE expr','expr',2,'p_expr_negate','main.py',362),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_parens','main.py',368),
  ('expr -> IDENTIFIER','expr',1,'p_expr_identifier','main.py',375),
  ('expr -> INTEGER','expr',1,'p_expr_integer','main.py',382),
  ('expr -> STRING','expr',1,'p_expr_string','main.py',388),
  ('expr -> TRUE','expr',1,'p_expr_true','main.py',394),
  ('expr -> FALSE','expr',1,'p_expr_false','main.py',400),
]
