...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        movq %r14, 16(%r12)
                        ## initialize attributes
                        ## self[3] holds field int (IO)
                        movq $0, %r13
                        movq %r13, 24(%r12)
                        ## self[3] int initializer -- none 
                        movq %r12, %r13
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
...
Main.main:              ## method definition
			...
			je l3
                        movq %r13, 0(%rbp)
                        movq 0(%r13), %r13
                        ## case Int will jump to l4
                        ## case String will jump to l5
                        ## case Main will jump to l6
...
.globl string8
string8:                # "ERROR: 6: Exception: case without matching branch\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string9
string9:                # "ERROR: 6: Exception: case on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
