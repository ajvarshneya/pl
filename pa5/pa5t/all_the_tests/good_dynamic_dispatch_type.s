...
l3:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up c() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl string9
string9:                # "ERROR: 15: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
