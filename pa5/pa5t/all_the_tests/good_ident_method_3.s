...
Main.some_method:       ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        ## a
                        movq 24(%rbp), %r13
.globl Main.some_method.end
Main.some_method.end:   ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Main.another_method
Main.another_method:    ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        subq %r14, %rsp
                        ## return address handling
                        ## fp[4] holds argument b (String)
                        ## fp[3] holds argument c (Bool)
                        ## method body begins
                        ## b
                        movq 32(%rbp), %r13
.globl Main.another_method.end
Main.another_method.end:## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
