...
Object.type_name.end:   ## method body ends
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl A.some_method
A.some_method:          ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        movq $0, %r14
                        movq %r14, 24(%r13)
.globl A.some_method.end
A.some_method.end:      ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl A.overriden_method
A.overriden_method:     ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        movq $1, %r14
                        movq %r14, 24(%r13)
.globl A.overriden_method.end
A.overriden_method.end: ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl B.overriden_method
B.overriden_method:     ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        movq $2, %r14
                        movq %r14, 24(%r13)
.globl B.overriden_method.end
B.overriden_method.end: ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
