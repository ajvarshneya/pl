...
Main.main:              ## method definition
                        ...
                        popq %rbp
                        movq %r13, 0(%rbp)
                        ## fp[-1] holds local string (String)
                        ## new String
                        pushq %rbp
                        pushq %r12
                        movq $String..new, %r14
...
.globl l3
l3:                     pushq %r13
                        ## obtain vtable from object in r1 with static type Int
                        movq 16(%r13), %r14
                        ## look up type_name() at offset 4 in vtable
                        movq 32(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl l5
l5:                     pushq %r13
                        ## obtain vtable from object in r1 with static type Bool
                        movq 16(%r13), %r14
                        ## look up type_name() at offset 4 in vtable
                        movq 32(%r14), %r14
                        call *%r14
...
.globl string8
string8:                # "ERROR: 10: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string10
string10:               # "ERROR: 12: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string11
string11:               # "ERROR: 13: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
