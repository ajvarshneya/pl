...
Complex.reflect_Y.end:  ## method body ends
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Complex.equal
Complex.equal:          ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 2
...
l9:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up x_value() at offset 15 in vtable
                        movq 120(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l13:                    pushq %r13
                        ## obtain vtable from object in r1 with static type Complex
                        movq 16(%r13), %r14
                        ## look up y_value() at offset 16 in vtable
                        movq 128(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l14:                    ## true branch
                        ...
                        movq %r14, 24(%r13)
.globl l16
l16:                    ## end of if conditional
.globl l12
l12:                    ## end of if conditional
.globl Complex.equal.end
Complex.equal.end:      ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
Complex.x_value:        ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        ## x
                        movq 24(%r12), %r13
.globl Complex.x_value.end
Complex.x_value.end:    ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
Complex.y_value:        ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
                        ...
                        ## y
                        movq 32(%r12), %r13
.globl Complex.y_value.end
Complex.y_value.end:    ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
l26:                    pushq %r13
                        ## obtain vtable from object in r1 with static type Complex
                        movq 16(%r13), %r14
                        ## look up equal() at offset 14 in vtable
                        movq 112(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl string11
string11:               # "ERROR: 35: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string12
string12:               # "ERROR: 62: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string13
string13:               # "ERROR: 64: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string14
string14:               # "ERROR: 3: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string15
string15:               # "ERROR: 6: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string18
string18:               # "ERROR: 11: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string19
string19:               # "ERROR: 0: Exception: String.substr out of range\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
