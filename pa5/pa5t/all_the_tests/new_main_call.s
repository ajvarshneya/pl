...
.globl l3
l3:                     pushq %r13
                        ## obtain vtable from object in r1 with static type Main
                        movq 16(%r13), %r14
                        ## look up main() at offset 9 in vtable
                        movq 72(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string8
string8:                # "ERROR: 4: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
